...
**Issue:** #100, #107
**Author:** Vila
**Status:** Draft v3 — 回应 Kevin review comments
...
- **org_id**（UUID）— 如 `8375851a-94ec-4efb-bd0d-7ec6d4cab536`，创建后永不变
- **agent_id**（UUID）— 如 `c50218b6-4a1a-438d-9ab9-be8ab20ea81d`
...
```
agent.scope = "8375851a-94ec-4efb-bd0d-7ec6d4cab536"
task.scope = "8375851a-94ec-4efb-bd0d-7ec6d4cab536"
event.scope = "8375851a-94ec-4efb-bd0d-7ec6d4cab536"
```
...
Kevin 的问题：「有更智能的方式来配置或者识别么？」「Server 有没有友好的方式来注册？」
...
```json
{
  "scopes": [
    {
      "agent_token": "bot_5c7a84757b...",
      "gitlab": { "url": "https://git.coco.xyz", "token": "...", "group_id": 2 }
    },
    {
      "agent_token": "bot_a128c37ec5...",
  ...
  "scopes": [
    {
      ...
      "agent_token": "bot_5c7a84757b...",
      "org_id": "8375851a-94ec-4efb-bd0d-7ec6d4cab536",
      "name": "HxA Team K",
      "gitlab": { "url": "https://git.coco.xyz", "token": "...", "group_id": 2 }
    }
  ]
...
GET /api/scopes → {
  scopes: [
    { id: "8375851a-...", name: "HxA Team K", hub: "connect.coco.xyz" },
    { id: "b9a1f24b-...", name: "HxA Team J", hub: "connect.coco.xyz" },
